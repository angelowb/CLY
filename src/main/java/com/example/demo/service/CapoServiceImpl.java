...
public class CapoServiceImpl implements CapoService{
    ...
    @Override
    public Object validaCapo(Capo capo, String nome, int idGenere, int idCategoria, int idStagione, int idEvento, int idColore, int input) {
        ...
        if(input == 0 && capo.getFoto() == null)
            errori.put("foto","Carica una foto");
