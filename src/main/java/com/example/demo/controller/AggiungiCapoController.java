...
public class AggiungiCapoController {
   ...
   public String formManager(@RequestParam("nome")String nome,
       ...
       System.out.println("Input FOTO: "+input);
       Object risultatoValidazione = capoService.validaCapo(capo, nome, idGenere, idCategoria, idStagione, idEvento, idColore, input);
